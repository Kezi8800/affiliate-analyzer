...
// Main Analyze Engine v4.1.1
// Fix: Partnerize / Pepperjam forced detection + correct bracket structure
...
function analyzeLink(inputUrl) {
  ...
  if (forcePartnerizePepperjam) {
    ...
    return {
      ok: true,
      version: "v4.1.1-partnerize-force",
      engine: "BrandShuo Attribution Intelligence Engine v4.1.1",
