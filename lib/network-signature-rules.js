...
const NETWORK_SIGNATURE_RULES = [
  ...
  },
  {
    ...
    param_keys: ["sscid", "afftrack", "sscid"],
    type: "Affiliate Network",
    confidence: "High"
  },
  {
  ...
  },
  {
    ...
    patterns: ["partnerboost", "pbid", "pb_clickid", "pb_source"],
    param_keys: ["pb", "pb_id", "pb_clickid", "pb_source"],
    type: "Affiliate Network",
    confidence: "High"
  },
  {
  ...
  },
  {
    ...
    platform: "Amazon",
    patterns: ["maas", "aa_campaignid", "aa_adgroupid", "aa_creativeid"],
